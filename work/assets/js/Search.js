 window.onload = function () {
        ...
        for(var i=0;i<songList_elemt.length;i++){
            ...
            var url = "music_player_song.jsp"+"?value="+ value + "&songid=" + songList_elemt[i]['song_id'];  //
        ...
        for(var i=0;i<songListS_elemt.length;i++){
            ...
            var url = "single_playlist_info.jsp?id="+songListS_elemt[i]["playlist_id"];
        ...
        function collect_playlist(list_id)   //利用ajax向后台发送歌单id
        {
                ...
                var url =  "ajax_addsonglist.jsp?songlistid=" + list_id;
        ...
        function add_list()
        {
                ...
                // 打开http请求（open）的参数： get|post， url，是否异步发送
                var url = "ajax_addsong.jsp?songlistid=" + this.id + "&songid=" +click_songid;
