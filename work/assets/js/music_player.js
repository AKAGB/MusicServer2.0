window.onload = function () {
    ...
    function playOrPause() {
        ...
        if (playState == 0) {
        	audio.play();
        	singer_img.classList.add('play-rotate');
        }
            
        else {
        	audio.pause();
        	singer_img.classList.remove('play-rotate');
        }
    ...
    function playAudio(index) {
        ...
        var url = 'get_music_detail.jsp?id=' + musicList[index]['song_id'];
    ...
    var 
        ...
        singer_img = document.getElementById('singer_img');
